...
import 'package:socialmedia_app/data/model/unfollow/un_follow.dart';

class UnFollowService {
  static const String baseUrl = ConstantUrl.baseUrl;
  static const String endPoint = ConstantUrl.unFollowUrl;
  static const String apiKey = ConstantApi.apiKey;

  Future<UnFollow?> unFollow(String id) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        log(response.body);
        return UnFollow.fromMap(jsonResponse);
      } else {
